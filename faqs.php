    ...
    <div id="wrapper" class="wrapper">
                    ...
                    <div class="row no-gutters d-flex align-items-center">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="header-action-items-layout1">
                                <ul>
                                    <li>
                                        <a href="appointment.php" class="action-items-primary-btn">Appointment<i class="fas fa-chevron-right"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <footer>
            ...
            <section class="footer-bottom-wrap">
                <div class="copyright">Copyright @ 2018 medilink. All Rights Reserved.<a target="_blank" href="https://www.radiustheme.com" rel="nofollow"> RadiusTheme</a></div>
            </section>
        </footer>
